...
def cal_robot_vel_f(intrin_para, bbcx, bbcy, bbtlx,bbtly, dist, gain=1, gain_p=1):
    ...
    if dist == 0:
        ...
        img_jacobian = np.array(
            ...
            [fx/dist, 0, bbtlx/dist, -bbtlx*bbtly/fx, (fx**2+bbtlx**2)/fx,bbtly], 
        ...
        print('bb width:{}, bb height:{}'.format(2*(bbcx-bbtlx),2*(bbcy-bbtly)))
        ...
        # center_vel = np.array([[bbcx-cx],[bbcy-cy]])
